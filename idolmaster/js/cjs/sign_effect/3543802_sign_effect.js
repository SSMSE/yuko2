...
(lib.reflect_mask_3543802 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,204,255,0.502)").s().p("");
	this.shape.setTransform(0.0111,0.0258);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_3543802, new cjs.Rectangle(-98.6,-95.8,197.3,191.7), null);
...
(lib.reflect = function(mode,startPosition,loop) {
	...
	this.lighter_tgt.setTransform(0,-174.1,0.7,0.7,0,0,-20.001);
	this.lighter_tgt.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-245.9,197.4,491.9), null);


(lib.reflect_container_cjs_3543802 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.5,341.95,1,1,0,0,0,-0.5,0.1);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:-0.1,y:-0.1},9,cjs.Ease.get(-1)).to({regY:0.1,y:-341.75},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-587.8,197.4,1175.6);
...
(lib.reflect_wrapper_3543802 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_3543802();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_3543802, new cjs.Rectangle(0,-245.9,197.4,491.9), null);
...
(lib.sign_effect_3543802 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(106.9,603.9,0.948,0.948);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(46.9,541.2,0.948,0.948);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(80.85,678.75,0.948,0.948);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(121.55,545.65,0.687,0.687);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(203.5,582.75,0.6563,0.6563);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(169.15,503.95,0.6256,0.6256);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(223.9,661.75,0.948,0.948);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_3543802();
	this.reflect_mask.name = "reflect_mask";
	this.reflect_mask.parent = this;
	this.reflect_mask.setTransform(133.4,592.55);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(116.0445,344.2158);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_3543802();
	this.reflect_wrapper.name = "reflect_wrapper";
	this.reflect_wrapper.parent = this;
	this.reflect_wrapper.setTransform(34.7,592.55);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_3543802, new cjs.Rectangle(-6.3,162.1,338.3,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_3543802();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(-6.3,0,646.3,838.5), null);


// stage content:
(lib._3543802_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(135.4,419.3,1,1,0,0,0,135.4,419.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(313.7,746.6,-36.599999999999966,91.89999999999998);
// library properties:
lib.properties = {
	id: '_3543802_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_3543802_sign_effect'] = {
